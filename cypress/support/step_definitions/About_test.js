...
Given("Visit and check aboutPage media masking", () => {
  cy.fixture("journals").then((data) => {
    ...
    for (let i = 0; i < data.length; i++) {
      var Unmasked = [];
      var Masked = [];
      const unmaskFile = "cypress/downloads/About/unmasked.json";
      const maskFile = "cypress/downloads/About/masked.json";
      const page = data[i];
      cy.request({
        url: `${page}/pages/about/`,
